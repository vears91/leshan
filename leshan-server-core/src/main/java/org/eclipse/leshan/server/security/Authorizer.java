 ...
 * 
 * Generally, it checks if the client endpoint and {@link Identity} is correct using data in {@link SecurityStore}.
 */
public interface Authorizer {
     ...
     *        For register request this is the registration which will created<br>
     ...
     * @param securityStore the securityStore which contains securityInfo for a given endpoint.
     * 
